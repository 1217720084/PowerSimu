...
system.Pss2.mosig([0], [1], 2)

# 重新生成对应维度的x, y, g, f
newx = [0.0] * (system.DAE.nx - nx_old)
...
# tt = [0.0]
# pyiter = []
system.DAE.x[0] = round(system.DAE.x[0], 14)
vv = [system.DAE.x[0]]
tt = [0.0]
pyiter = []
# 主循环
...
var = matrix(var)
var = var.T
sio.savemat('C://Users//user//Desktop//平台//余伟洲//仿真结果//吴老师//text_d_036_5//restdvar.mat', {'var': var, 't': t0})
