...
if __name__ == '__main__':
    ...
    datafile = path + '\\text\\text_d_036_pss2.txt'
    n = 1
    ...
    for k in range(pi):
        for h in range(pj):
            ...
            system.Avr2.bv = []
            datafile = path + '\\text\\text_d_036_pss2.txt'
            [As, Gyx, w] = sssa(datafile, k, h)
            sio.savemat(path + 'outputA_' + str(k + 1), {'As': As, 'Gyx': Gyx, 'eigens': w})
